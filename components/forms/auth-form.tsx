...
export function AuthForm({
  ...
  async function onSubmit(values: AuthInput) {
    ...
    try {
      ...
      startTransition(() => {
        setMessage(
          "Magic link sent. Open the email on this device and CPA StudyPilot will reconcile any pending purchases after sign-in."
        );
      });
    } finally {
      setIsPending(false);
  ...
  return (
    <Card className="w-full">
      ...
      <h1 className="mt-5 font-serif text-4xl text-zinc-950">
        {mode === "sign-in" ? "Open your study dashboard" : "Create your CPA StudyPilot account"}
      </h1>
