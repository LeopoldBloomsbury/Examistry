    ...
    <>
      <Section className="pt-20">
        ...
        <p className="mt-6 max-w-3xl text-lg leading-8 text-zinc-600">
          CertKit is meant to feel closer to Stripe, Linear, and premium DTC education than to marketplace junk. Every content object exists because it makes the user’s next decision clearer.
        </p>
      </Section>
